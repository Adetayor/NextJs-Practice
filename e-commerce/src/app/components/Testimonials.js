            ...
            <div className='grid lg:grid-cols-[300px,1fr] gap-4'>
                <div className='border border-gray-300 rounded-2xl grid place-items-center p-6 lg:p-0'>
                    <div className='text center flex-col items-center gap-1'>
                        ...
                        <Image className='inline-black py-2' src="/quotes.svg"
                        width={30} height={30} alt="quotes" />
                        <p className='max-w-[200px] text-gray-500'>
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste quaerat id voluptates et repellat ipsam, assumenda voluptatem ex repellendus beatae aliquam? Hic quas assumenda dolores tenetur omnis incidunt reprehenderit esse.
                        </p>
                    </div>
                </div>
